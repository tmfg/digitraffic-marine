...
public class SsePropertiesV1 extends Properties {
    ...
    public SsePropertiesV1(final int siteNumber, final String siteName, final SiteType siteType, final Instant lastUpdate, final SeaState seaState, final Trend trend, final Integer windWaveDir,
    ...
    public boolean equals(final Object o) {
        ...
        final SsePropertiesV1 that = (SsePropertiesV1) o;
