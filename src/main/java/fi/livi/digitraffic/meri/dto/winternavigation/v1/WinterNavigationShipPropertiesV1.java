...
public class WinterNavigationShipPropertiesV1 extends Properties {
    ...
    public final WinterNavigationShipStateV1 shipState;
    ...
    public final WinterNavigationShipVoyageV1 shipVoyage;
    ...
    public final List<WinterNavigationShipActivityV1> shipActivities;
    ...
    public final List<WinterNavigationShipPlannedActivityV1> shipPlannedActivities;

    public WinterNavigationShipPropertiesV1(
        ...
        final WinterNavigationShipStateV1 shipState,
        final WinterNavigationShipVoyageV1 shipVoyage,
        final List<WinterNavigationShipActivityV1> shipActivities,
        final List<WinterNavigationShipPlannedActivityV1> shipPlannedActivities,
