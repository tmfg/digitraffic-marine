...
public class WinterNavigationPortRestrictionV1 {
    ...
    public WinterNavigationPortRestrictionV1(final Boolean isCurrent, final Boolean portRestricted, final Boolean portClosed, final Instant issueTime, final Instant lastModified,
                                             final LocalDate validFrom, final LocalDate validUntil, final String rawText, final String formattedText) {
